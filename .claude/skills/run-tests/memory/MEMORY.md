...
- [远程桌面观看验证](desktop-stream-verify.md) — fake-rfb 起停 / watch 全链路 / 抢占·关流·断开清理观测点 / 裸 token 401 的坑
- [Bun WS bufferedAmount 陷阱](bun-ws-bufferedamount-trap.md) — 只增不减、排空轮询必死锁；背压用字节差值护栏
