...
describe('BlinkText', () => {
    ...
    it('blinking=true 时应用扫光动画样式', () => {
        render(<BlinkText blinking color="#e8825c">Working</BlinkText>, { wrapper })
        const el = screen.getByText('Working')
        // styled-component 会生成带 class 的 span
        expect(el.tagName).toBe('SPAN')
    ...
    it('支持自定义 className 和 style', () => {
        render(
            <BlinkText blinking={false} className="custom" style={{ fontSize: 14 }}>
                Text
            </BlinkText>,
            { wrapper }
        )
