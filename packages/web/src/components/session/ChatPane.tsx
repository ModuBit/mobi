 ...
 *
 * 承载 PageHeader（SidebarToggle / 移动端 MobileMenuButton / PixelAvatar / 会话名 / 展开按钮）
 * + SessionContextBar + ChatContainer。展开按钮仅在检视面板收起（!expanded）时显示，
 * 点击后调用 setExpanded(sessionId, true) 展开检视面板。
 */
